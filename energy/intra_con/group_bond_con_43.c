...
/*cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc*/
/*==========================================================================*/
void shake_43(GRP_BOND_CON *grp_bond_con,
...
/* Compute difference vectors */
 ...
 /*    test1= dij[1][1]*dij[1][1] - (dx[1][1]*dx[1][1] + dy[1][1]*dy[1][1]
                    + dz[1][1]*dz[1][1]);
     test2= dij[2][1]*dij[2][1] - (dx[2][1]*dx[2][1] + dy[2][1]*dy[2][1]
                    + dz[2][1]*dz[2][1]);
     test3= dij[3][1]*dij[3][1] - (dx[3][1]*dx[3][1] + dy[3][1]*dy[3][1]
                    + dz[3][1]*dz[3][1]);
     printf("test1 % 8.7e \n",test1);
     printf("test2 % 8.7e \n",test2);
     printf("test3 % 8.7e \n",test3); */
...
void rattle_43(GRP_BOND_CON *grp_bond_con,
              CLATOMS_INFO *clatoms_info,CLATOMS_POS *clatoms_pos,
